...
public sealed class EquipmentMySqlRepository : IEquipmentRepository
{
    ...
    public void Insert(EquipmentDto equipment)
    {
        ...
        command.Parameters.Add(CreateParameter(command, "@nom", equipment.Nom));
        command.Parameters.Add(CreateParameter(command, "@codeParc", equipment.CodeParc));
        command.Parameters.Add(CreateParameter(command, "@numeroSerie", equipment.NumeroSerie));
        command.Parameters.Add(CreateParameter(command, "@marque", equipment.Marque));
        command.Parameters.Add(CreateParameter(command, "@commentaire", equipment.Commentaire));
