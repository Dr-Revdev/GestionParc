...
public class FreeEquipmentView : UserControl
{
    ...
    private ListView lvAvailable = null!;
    private ListViewColumnSorter lvAvailableSorter = null!;

    // Affichage milieu
    private TextBox tbSearchReturned = null!;
    private Button btnSearchReturned = null!;
    private ListView lvReturned = null!;
    private ListViewColumnSorter lvReturnedSorter = null!;

    // Affichage détail sélection droite
    private TextBox tbType = null!, tbName = null!, tbCodeParc = null!, tbSerial = null!, tbBrand = null!, tbComment = null!;
    private CheckBox cbxRenduDsem = null!;
    private Label lblDateRenduDsem = null!;
